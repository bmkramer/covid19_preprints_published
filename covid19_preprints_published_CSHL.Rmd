...
#preprints_matched <- read_csv("data/covid19_preprints_published_CSHL.csv")
...
#preprints_matched_time_to_publish <- read_csv("data/covid19_preprints_published_CSHL_time_to_publish.csv")
...
p2 <- preprints_matched_time_to_publish %>%
  ...
  mutate(covid_preprint = case_when(
           !is.na(is_preprint_of) ~ "linked in Crossref",
